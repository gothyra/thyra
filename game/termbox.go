...
func write_sgr_fg(a Attribute, c Client) {
	switch output_mode {
	case Output256, Output216, OutputGrayscale:
		c.Buff.WriteString("\033[38;5;")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(a-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	default:
		c.Buff.WriteString("\033[3")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(a-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	}
...
func write_sgr_bg(a Attribute, c Client) {
	switch output_mode {
	case Output256, Output216, OutputGrayscale:
		c.Buff.WriteString("\033[48;5;")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(a-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	default:
		c.Buff.WriteString("\033[4")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(a-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	}
...
func write_sgr(fg, bg Attribute, c Client) {
	switch output_mode {
	case Output256, Output216, OutputGrayscale:
		c.Buff.WriteString("\033[38;5;")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(fg-1), 10))
		c.Buff.WriteString("m")
		c.Buff.WriteString("\033[48;5;")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(bg-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	default:
		c.Buff.WriteString("\033[3")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(fg-1), 10))
		c.Buff.WriteString(";4")
		c.Buff.Write(strconv.AppendUint(intbuf, uint64(bg-1), 10))
		c.Buff.WriteString("m")
		io.WriteString(c.Conn, c.Buff.String())
	}
...
func send_attr(fg, bg Attribute, c Client) {
	...
	if fgcol != ColorDefault {
		if bgcol != ColorDefault {
			write_sgr(fgcol, bgcol, c)
		} else {
			write_sgr_fg(fgcol, c)
		}
	} else if bgcol != ColorDefault {
		write_sgr_bg(bgcol, c)
	}

	if fg&AttrBold != 0 {
		io.WriteString(c.Conn, funcs[t_bold])

	}
	if bg&AttrBold != 0 {
		io.WriteString(c.Conn, funcs[t_blink])
	}
	if fg&AttrUnderline != 0 {
		io.WriteString(c.Conn, funcs[t_underline])
	}
	if fg&AttrReverse|bg&AttrReverse != 0 {
		io.WriteString(c.Conn, funcs[t_reverse])
	}
